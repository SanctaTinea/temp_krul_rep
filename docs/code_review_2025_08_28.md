...
> **Исторический документ.** Это снимок draft-репозитория и протокола JSON v3
> от 2025-08-28, а не текущий backlog. Актуальная реализация использует Krul v4,
> transport v1 и корневую standalone-сборку; выполненные пункты из этого обзора
> намеренно не вычёркиваются.
